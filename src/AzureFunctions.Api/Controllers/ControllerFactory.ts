...
//   private static axiosClient: AxiosInstance;
  ...
  public async createPatientController(functionContext: TraceContext, request: HttpRequest): Promise<PatientController> {
    ...
    // const httpDataService = new HttpDataService(ControllerFactory.axiosClient);
...
//   }
  ...
  private async CreateCollection(collectionName: string): Promise<ICollection> {
    ...
    return new DbCollection(retryCollection, collectionName, this.settings.patientTestDatabase);
  }
