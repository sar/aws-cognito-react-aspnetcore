...
// And: https://stackoverflow.com/questions/54495039/cognito-check-validity-of-idtoken
...
const cognitoPoolId = awsmobile.aws_user_pools_id; // process.env.COGNITO_POOL_ID || '';
if (!cognitoPoolId) {
	throw new Error('env var required for cognito pool');
}
const cognitoRegion = awsmobile.aws_cognito_region;
if (!cognitoRegion) {
